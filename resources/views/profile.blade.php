...
<div class="space-y-6 max-w-md mx-auto py-2">
    ...
    @if(auth()->check() && auth()->user()->role === 'ranger')
        ...
        <div class="card-gg p-6 space-y-5 bg-[#FBFAF0]">
            <!-- Header -->
            <div class="flex items-center gap-2.5 border-b border-[#1F3D20]/10 pb-3.5">
                <div class="w-8 h-8 rounded-xl bg-[#1F3D20]/10 flex items-center justify-center">
                    <svg class="w-4 h-4 text-[#1F3D20]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
                <div>
                    <h3 class="font-baloo font-bold text-base text-[#1F3D20] leading-tight">{{ __('profile.account_settings') }}</h3>
                    <p class="text-[11px] font-nunito text-[#6B6B55]">Kelola informasi akun & kata sandi Anda</p>
                </div>
            </div>
            
            <!-- User Information -->
            <div class="bg-white p-3.5 rounded-xl border border-[#1F3D20]/10">
                <div class="flex items-center justify-between text-xs font-nunito pb-2 mb-2 border-b border-[#1F3D20]/5">
                ...
                <div class="flex items-center justify-between text-xs font-nunito">
                    ...
                    <span class="px-2.5 py-0.5 rounded-full text-[10px] font-baloo font-extrabold bg-[#1F3D20]/10 text-[#1F3D20] uppercase tracking-wide">{{ auth()->user()->role }}</span>
                </div>
            </div>

            <!-- Change Password Section -->
            <div class="space-y-3.5">
                <h4 class="font-baloo font-bold text-xs uppercase tracking-wider text-[#1F3D20] flex items-center gap-2">
                    <svg class="w-3.5 h-3.5 text-[#1F3D20]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                ...
                <form method="POST" action="{{ route('profile.password.update') }}" class="space-y-3">
                    ...
                    <div>
                        ...
                        <div style="display:flex;align-items:center;border:1px solid rgba(31,61,32,0.2);border-radius:0.75rem;background:#fff;overflow:hidden;transition:all 0.2s;" onfocus="this.style.borderColor='#1F3D20'" class="focus-within:border-[#1F3D20] focus-within:ring-1 focus-within:ring-[#1F3D20]/30">
                            <input type="password" id="ranger_current_password" name="current_password" required placeholder="{{ __('profile.current_password_placeholder') }}" class="flex-1 min-w-0 text-xs font-nunito bg-transparent text-[#1F3D20] placeholder:text-[#6B6B55]/50 focus:outline-none" style="padding:10px 0 10px 14px;border:none;" />
                            <button type="button" onclick="togglePasswordVisibility('ranger_current_password', this)" style="flex-shrink:0;width:40px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:#5C574C;padding:0;" title="Tampilkan/Sembunyikan Kata Sandi">
                                <svg class="eye-open" style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="eye-closed" style="width:16px;height:16px;display:none;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.05 10.05 0 014.122-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/></svg>
                            </button>
                        </div>
                        @error('current_password')
                            <span class="text-[11px] text-red-600 font-nunito font-semibold block mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div style="display:flex;align-items:center;border:1px solid rgba(31,61,32,0.2);border-radius:0.75rem;background:#fff;overflow:hidden;transition:all 0.2s;" class="focus-within:border-[#1F3D20] focus-within:ring-1 focus-within:ring-[#1F3D20]/30">
                            <input type="password" id="ranger_password" name="password" required placeholder="{{ __('profile.new_password_placeholder') }}" class="flex-1 min-w-0 text-xs font-nunito bg-transparent text-[#1F3D20] placeholder:text-[#6B6B55]/50 focus:outline-none" style="padding:10px 0 10px 14px;border:none;" />
                            <button type="button" onclick="togglePasswordVisibility('ranger_password', this)" style="flex-shrink:0;width:40px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:#5C574C;padding:0;" title="Tampilkan/Sembunyikan Kata Sandi">
                                <svg class="eye-open" style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="eye-closed" style="width:16px;height:16px;display:none;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.05 10.05 0 014.122-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/></svg>
                            </button>
                        </div>
                    ...
                    <div>
                        ...
                        <div style="display:flex;align-items:center;border:1px solid rgba(31,61,32,0.2);border-radius:0.75rem;background:#fff;overflow:hidden;transition:all 0.2s;" class="focus-within:border-[#1F3D20] focus-within:ring-1 focus-within:ring-[#1F3D20]/30">
                            <input type="password" id="ranger_password_confirmation" name="password_confirmation" required placeholder="{{ __('profile.confirm_new_password_placeholder') }}" class="flex-1 min-w-0 text-xs font-nunito bg-transparent text-[#1F3D20] placeholder:text-[#6B6B55]/50 focus:outline-none" style="padding:10px 0 10px 14px;border:none;" />
                            <button type="button" onclick="togglePasswordVisibility('ranger_password_confirmation', this)" style="flex-shrink:0;width:40px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:#5C574C;padding:0;" title="Tampilkan/Sembunyikan Kata Sandi">
                                <svg class="eye-open" style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="eye-closed" style="width:16px;height:16px;display:none;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.05 10.05 0 014.122-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/></svg>
                            </button>
                        </div>
            ...
            <div class="pt-3 border-t border-[#1F3D20]/10">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full py-2.5 rounded-xl bg-white border border-[#C0392B]/30 hover:bg-[#C0392B] text-[#C0392B] hover:text-white font-baloo font-bold text-xs transition-all cursor-pointer flex items-center justify-center gap-2 active:scale-[0.99]">
    ...
    @else
        ...
        <div class="card-gg p-6 space-y-5 bg-[#FBFAF0]">
            ...
            <div class="bg-white p-3.5 rounded-xl border border-[#1F3D20]/10">
                ...
                <div class="flex items-center justify-between text-xs font-nunito">
                    <span class="text-[#6B6B55] font-semibold">Peran Utama</span>
                    <span class="px-2.5 py-0.5 rounded-full text-[10px] font-baloo font-extrabold bg-[#1F3D20]/10 text-[#1F3D20] uppercase tracking-wide">{{ $user->role }}</span>
                </div>
            </div>
            ...
            <div class="space-y-3.5">
                ...
                <form method="POST" action="{{ route('profile.password.update') }}" class="space-y-3">
                    ...
                    <div>
                        <label class="block text-[11px] font-baloo font-bold text-[#1F3D20] mb-1">{{ __('profile.current_password_label') }}</label>
                        <div style="display:flex;align-items:center;border:1px solid rgba(31,61,32,0.2);border-radius:0.75rem;background:#fff;overflow:hidden;transition:all 0.2s;" class="focus-within:border-[#1F3D20] focus-within:ring-1 focus-within:ring-[#1F3D20]/30">
                            <input type="password" id="viewer_current_password" name="current_password" required placeholder="{{ __('profile.current_password_placeholder') }}" class="flex-1 min-w-0 text-xs font-nunito bg-transparent text-[#1F3D20] placeholder:text-[#6B6B55]/50 focus:outline-none" style="padding:10px 0 10px 14px;border:none;" />
                            <button type="button" onclick="togglePasswordVisibility('viewer_current_password', this)" style="flex-shrink:0;width:40px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:#5C574C;padding:0;" title="Tampilkan/Sembunyikan Kata Sandi">
                                <svg class="eye-open" style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="eye-closed" style="width:16px;height:16px;display:none;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.05 10.05 0 014.122-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/></svg>
                            </button>
                        </div>
                    ...
                    <div>
                        <label class="block text-[11px] font-baloo font-bold text-[#1F3D20] mb-1">{{ __('profile.new_password_label') }}</label>
                        <div style="display:flex;align-items:center;border:1px solid rgba(31,61,32,0.2);border-radius:0.75rem;background:#fff;overflow:hidden;transition:all 0.2s;" class="focus-within:border-[#1F3D20] focus-within:ring-1 focus-within:ring-[#1F3D20]/30">
                            <input type="password" id="viewer_password" name="password" required placeholder="{{ __('profile.new_password_placeholder') }}" class="flex-1 min-w-0 text-xs font-nunito bg-transparent text-[#1F3D20] placeholder:text-[#6B6B55]/50 focus:outline-none" style="padding:10px 0 10px 14px;border:none;" />
                            <button type="button" onclick="togglePasswordVisibility('viewer_password', this)" style="flex-shrink:0;width:40px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:#5C574C;padding:0;" title="Tampilkan/Sembunyikan Kata Sandi">
                                <svg class="eye-open" style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="eye-closed" style="width:16px;height:16px;display:none;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.05 10.05 0 014.122-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/></svg>
                            </button>
                        </div>
                    ...
                    <div>
                        <label class="block text-[11px] font-baloo font-bold text-[#1F3D20] mb-1">{{ __('profile.confirm_new_password_label') }}</label>
                        <div style="display:flex;align-items:center;border:1px solid rgba(31,61,32,0.2);border-radius:0.75rem;background:#fff;overflow:hidden;transition:all 0.2s;" class="focus-within:border-[#1F3D20] focus-within:ring-1 focus-within:ring-[#1F3D20]/30">
                            <input type="password" id="viewer_password_confirmation" name="password_confirmation" required placeholder="{{ __('profile.confirm_new_password_placeholder') }}" class="flex-1 min-w-0 text-xs font-nunito bg-transparent text-[#1F3D20] placeholder:text-[#6B6B55]/50 focus:outline-none" style="padding:10px 0 10px 14px;border:none;" />
                            <button type="button" onclick="togglePasswordVisibility('viewer_password_confirmation', this)" style="flex-shrink:0;width:40px;display:flex;align-items:center;justify-content:center;background:none;border:none;cursor:pointer;color:#5C574C;padding:0;" title="Tampilkan/Sembunyikan Kata Sandi">
                                <svg class="eye-open" style="width:16px;height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="eye-closed" style="width:16px;height:16px;display:none;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.05 10.05 0 014.122-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/></svg>
                            </button>
                        </div>
